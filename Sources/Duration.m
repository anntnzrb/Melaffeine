...
NSTimeInterval CTDurationMultiplierForUnitIndex(NSInteger unitIndex) {
    if (unitIndex == CTUnitMinutesIndex) { return CTSecondsPerMinute; }
    if (unitIndex == CTUnitHoursIndex) { return CTSecondsPerHour; }
...
NSNumber *CTDurationSecondsFromInputString(NSString *string, NSInteger unitIndex) {
